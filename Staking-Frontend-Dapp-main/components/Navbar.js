...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-between items-center py-4 px-8 bg-[#1b1b1b] text-white">
       <div>
      <a className="hover:text-gray-300 cursor-pointer">
        <Image src={Logo} alt="VoteBlock logo" width={100} height={50} />
      </a>
    </div>

      <div>
        <button
          className="bg-[#1b1b1b] text-gray-300 py-2 px-4 rounded-half border-gray-500 border-2"
