...
const StakingForm = () => {
  ...
  const contractAddress = "0xafAa57C68aD8ecB79E7F792f2B5683817B42467D";
  // store staking contract address
  const stakingContractAddress = "0x1A6c70F679c9CaEbD86d5BF3B08bD3b3BcB86866";
        ...
        <div className="w-full md:w-1/2">
          <form className="bg-white rounded px-4 md:px-8 pt-6 pb-8 mb-4 shadow-md mx-2 md:mx-auto">
            <h2 className="text-extra-large font-bold my-4 text-center">
              Stake <span className="text-[#6837cf] mt-4">$KNG</span>
            </h2>
            <div className="mb-4">
              <label
              ...
              <input
                ...
                id="amount"
                type="number"
                placeholder="Enter amount to stake ($KNG)"
